  ...
  <div className="flex items-center gap-3 p-3 bg-card text-card-foreground rounded-xl border">
    <div className="flex items-center gap-1.5">
      ...
      <span className="text-sm font-bold">
        {timeAndRoi.estimated_reading_time_minutes}
      </span>
    ...
    <div className="flex items-center gap-1">
      ...
      <Badge
        variant={getLevelBadgeVariant(timeAndRoi.content_density)}
    ...
    <div className="flex items-center gap-1">
      ...
      <Badge
        variant={getLevelBadgeVariant(timeAndRoi.expected_usefulness)}
        className="text-xs h-4 px-1.5"
      >
